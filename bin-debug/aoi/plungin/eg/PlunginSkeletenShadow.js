...
(function (aoi) {
    ...
    var PlunginSkeletenShadow = (function (_super) {
        ...
        PlunginSkeletenShadow.prototype.getAttArr = function () {
            var arr = _super.prototype.getAttArr.call(this);
            arr.push({ type: 2, name: "u_shadowVar" });
            return arr;
        };
        PlunginSkeletenShadow.prototype.updateCode = function () {
        ...
        PlunginSkeletenShadow.prototype.active = function (gl, subGeo, target, camera, program, renderType) {
        ...
        PlunginSkeletenShadow.prototype.genFramentCode2_shadow = function () {
            var str = 'uniform vec4 u_shadowVar;\n';
            return str;
        };
        PlunginSkeletenShadow.prototype.genFramentCode_shadow = function () {
        ...
        return PlunginSkeletenShadow;
    }(aoi.PlunginSkeletenBase));
    aoi.PlunginSkeletenShadow = PlunginSkeletenShadow;
    __reflect(PlunginSkeletenShadow.prototype, "aoi.PlunginSkeletenShadow");
})(aoi || (aoi = {}));
//# sourceMappingURL=PlunginSkeletenShadow.js.map